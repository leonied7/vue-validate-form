(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VueValidateForm = {}));
  ...
  var script = {
    ...
    computed: {
      ...
      values: function values() {
        return Object.entries(this.flatValues).reduce(function (result, _ref) {
          var _ref2 = _slicedToArray(_ref, 2),
              name = _ref2[0],
              value = _ref2[1];

          lodash_set(result, name, value);
          return result;
        }, {});
      },
      firstInvalidField: function firstInvalidField() {
        ...
        var name = Object.keys(this.fields).find(function (name) {
          return _this2.errors[name].length;
        });
        return this.fields[name];
      },
      existsErrors: function existsErrors() {
        return Object.values(this.errors).some(function (errors) {
          return errors.length;
        });
      }
    },
    created: function created() {
      this.innerDefaultValues = lodash_clonedeep(this.defaultValues);
    },
    methods: {
      ...
      updateField: function updateField(oldName, _ref4) {
        var name = _ref4.name,
            rules = _ref4.rules,
            focus = _ref4.focus;
        this.$set(this.fields, oldName, {
          rules: rules,
          focus: focus
        });
      ...
      replaceFieldName: function replaceFieldName(from, to) {
        if (from === to) {
          return;
        }
      ...
      setError: function setError(name, message) {
        if (this.errors[name] === undefined) {
          throw new Error("field '".concat(name, "' must be registered for set error"));
        }
      ...
      validateField: function validateField(name) {
        ...
        var value = this.flatValues[name];
        Object.entries(rules).forEach(function (_ref5) {
          ...
          if (!validator) {
            throw new Error("validator '".concat(ruleName, "' must be registered"));
          }

          if (!validator(value, options.params)) {
            _this4.setError(name, options.message);
          }
        });
      },
      getFieldDefaultValues: function getFieldDefaultValues(name, defaultValue) {
        return lodash_get(this.innerDefaultValues, name, defaultValue);
      },
      getFieldErrors: function getFieldErrors(name) {
      ...
      reset: function reset(values) {
        ...
        if (values) {
          this.innerDefaultValues = lodash_clonedeep(values);
        }

        Object.entries(this.defaultValuesByField).forEach(function (_ref7) {
          var _ref8 = _slicedToArray(_ref7, 2),
              name = _ref8[0],
              value = _ref8[1];

          var defaultValue = _this5.getFieldDefaultValues(name, value);

          _this5.defaultValuesByField[name] = defaultValue;

          _this5.setValue(name, defaultValue);
        });
      }
    },
  ...
  var script$1 = {
    ...
    inject: ['addField', 'removeField', 'updateField', 'setValue', 'setFieldError', 'getFieldDefaultValues', 'getFieldValue', 'getFieldErrors'],
    model: {
      prop: 'modelValue',
    ...
    computed: {
      providedDefaultValue: function providedDefaultValue() {
        return this.getFieldDefaultValues(this.name);
      },
      providedValue: function providedValue() {
    ...
    watch: {
      ...
      providedValue: function providedValue(value) {
    ...
    methods: {
      onModelChange: function onModelChange(value) {
        ...
        this.$nextTick(function () {
          value = _this.hasModelValue ? _this.computedModelValue : value;

          _this.setValue(_this.name, value);
        });
      },
