(function (global, factory) {
    ...
    methods: {
      ...
      setErrors: function setErrors(errors) {
        ...
        Object.entries(errors).forEach(function (_ref5) {
          ...
          _this2.setFieldError(name, error);
        });
      },
      setFieldError: function setFieldError(name, message) {
      ...
      validateField: function validateField(name) {
        ...
        Object.entries(rules).forEach(function (_ref7) {
          ...
          if (!lodash_isequal(validator(value), options.value)) {
            _this3.setFieldError(name, options.message);
          }
        });
      },
      ...
      reset: function reset(values) {
        ...
        Object.entries(this.defaultValuesByField).forEach(function (_ref9) {
          var _ref10 = _slicedToArray(_ref9, 2),
              name = _ref10[0],
              value = _ref10[1];

          var defaultValue = _this4.getFieldDefaultValues(name, value);

          _this4.defaultValuesByField[name] = defaultValue;

          _this4.setValue(name, defaultValue);
        });
      }
    },
  ...
  var script$1 = {
    ...
    inject: ['addField', 'removeField', 'updateField', 'setValue', 'getFieldDefaultValues', 'getFieldValue', 'getFieldErrors'],
    model: {
      prop: 'modelValue',
